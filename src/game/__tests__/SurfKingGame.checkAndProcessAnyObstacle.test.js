    ...
    describe(`when the 'to' cell has a Cyclone obstacle`, () => {
        describe(`and Cyclone move player forward`, () => {
            ...
            it(`and new 'to' cell has an Island obstacle, the player should gain 2 energies`, () => {
                ...
                expect({ newTo, newEnergyToLose }).toEqual({ newTo: to + MOVE_FORWARD, newEnergyToLose: energyToLose - 2 });
            });
            ...
            it(`and new 'to' cell has a Storm obstacle, the player should lose 1 energy`, () => {
                ...
                expect({ newTo, newEnergyToLose }).toEqual({ newTo: to + MOVE_FORWARD, newEnergyToLose: energyToLose + 1 });
            });
            ...
            it(`and new 'to' cell has a Stone obstacle, the player should move forward again`, () => {
                ...
                expect({ newTo, newEnergyToLose }).toEqual({ newTo: to + MOVE_FORWARD + MOVE_FORWARD, newEnergyToLose: energyToLose });
            });
        ...
        describe(`and Cyclone move player backward`, () => {
            ...
            xit(`and new 'to' cell has a Stone obstacle, the player should move backward again`, () => { // TODO: Check when "To" is negative.
                const player1 = { ...createPlayer(0, []), cellPosition: 0 };
                const player2 = { ...createPlayer(1, []), cellPosition: 1 };
                const to = 7;
                const cells = [...Array.from({ length: GRID_SIZE }, (_, i) => {
                ...
                expect({ newTo, newEnergyToLose }).toEqual({ newTo: to + MOVE_BACKWARD, newEnergyToLose: energyToLose });
            });
        });
    });
});